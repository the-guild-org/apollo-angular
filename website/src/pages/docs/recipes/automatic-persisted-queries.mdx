---
description:
  Improve GraphQL performance with Automatic Persisted Queries - sends a generated ID instead of
  query text, reducing overhead for client performance. Learn how to install and use in Angular.
---
...
Read more about
[Automatic Persisted Queries](https://www.apollographql.com/blog/improve-graphql-performance-with-automatic-persisted-queries).
